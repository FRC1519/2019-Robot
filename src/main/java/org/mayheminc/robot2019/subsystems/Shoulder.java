    ...
    public void update() {
        ...
        if (!m_manualMode) { // auto mode...
            ...
            case STOPPED:
                ...
                // this.motor_A.set(ControlMode.PercentOutput, 0, DemandType.ArbitraryFeedForward, m_feedForward);

                // for now, however, need to keep holding our position
                this.motor_A.set(ControlMode.MotionMagic, degreesToPosition(m_desiredAngle), DemandType.ArbitraryFeedForward, m_feedForward);
            ...
            motor_A.set(ControlMode.PercentOutput, Robot.oi.getOperatorLeftY(), DemandType.ArbitraryFeedForward, m_feedForward);

            // below code should be modified to engage the brake to help hold position in manualMode
            // if (this.manualMode == true && Robot.oi.getOperatorLeftY() == 0.0) {
            //     // TODO:  should really probably add the "FeedForward" term into this, too...
