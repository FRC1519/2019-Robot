...
public class StartRightHAB2HPtoRocketFront extends CommandGroup {
  ...
  public StartRightHAB2HPtoRocketFront() {
    ...
    addSequential(new DriveStraightOnHeading(0.9, 112, +40)); // head straight towards rocket

    // addSequential(new DriveStraightOnHeading(0.9, 116, 0)); // head straight
    // downfield
