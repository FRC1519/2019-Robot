...
public class LedPatternFactory {
    ...
    public static CyclePattern defaultAuto = new CyclePattern() {
        {
            add(new CycleElement(PatternID.BLUE, 0, 0.5));
            add(new CycleElement(PatternID.BLACK, 0, 0.5));
        }
    };

    public static CyclePattern defaultTeleOp = new CyclePattern() {
        {
            add(new CycleElement(PatternID.RED, 0, 0.5));
            add(new CycleElement(PatternID.BLACK, 0, 0.5));
        }
    };
    ...
    public static CyclePattern cargoBall = new CyclePattern() {
        {
            add(new CycleElement(PatternID.ORANGE, 0, 0.4));
            add(new CycleElement(PatternID.WHITE, 0, 0.2));
    ...
    public static CyclePattern hatchPanel = new CyclePattern() {
        {
            add(new CycleElement(PatternID.YELLOW, 0, 0.125));
            add(new CycleElement(PatternID.BLACK, 0, 0.125));
    ...
    public static CyclePattern test1 = new CyclePattern() {
        {
            add(new CycleElement(PatternID.RED, 0, 1.0));
            add(new CycleElement(PatternID.GREEN, 0, 1.0));
            add(new CycleElement(PatternID.BLUE, 0, 1.0));
