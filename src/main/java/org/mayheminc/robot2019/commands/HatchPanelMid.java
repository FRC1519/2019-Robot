...
public class HatchPanelMid extends CommandGroup {
  /**
   * Add your docs here.
   */
  public HatchPanelMid() {
    ...
    addSequential(new ArmMove(Shoulder.HP_ROCKET_MID_ANGLE, Wrist.HP_ROCKET_MID_ANGLE, Targeting.TargetHeight.HATCH));
