...
public class HatchPanelLow extends ParallelCommandGroup {
  /**
   * Add your docs here.
   */
  public HatchPanelLow() {
    addCommands(
      // turn on the targeting lights while scoring a hatch panel
      new TargetingLightsSet(TargetingLights.LIGHTS_ON), 

      // move the arm to the position for hatch panel low scoring
      new ArmMove(Shoulder.HP_ROCKET_LOW_ANGLE, Wrist.HP_ROCKET_LOW_ANGLE, Targeting.TargetHeight.HATCH)
      );
  }
}
