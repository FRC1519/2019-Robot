...
public class HAB2HPtoShipSideBackwards extends CommandGroup {
  ...
  public HAB2HPtoShipSideBackwards(Autonomous.StartOn startSide) {
    ...
    addSequential(new DriveStraightOnHeading(-0.5, 72, Autonomous.chooseAngle(startSide, 180.0)));
	...
	// Head for the cargo ship, by taking a long diagonal backwards path until beyond the rocket
    // guessing at 15 feet of driving distance.
    addSequential(new DriveStraightOnHeading(-0.7, 180, Autonomous.chooseAngle(startSide, 190.0)));
    ...
    addSequential(new DriveStraightOnHeading(0.6, 12, Autonomous.chooseAngle(startSide, 270.0)));
